...
try:
    ...
    from report_task.utils.maker.xls_maker import XlsMaker
except ImportError:
    import sys
...
FILE_PATH = os.path.join(SAVE_PATH, 'xls_maker_test.db')
CSV_PATH = os.path.join(SAVE_PATH, 'xls_maker_test.xls')
